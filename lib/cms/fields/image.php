...
class ImageField extends SimpletextField
{
	...
	public function insert( $values )
	{
		...
		if( $file[0] == 1 )
		{
			...
			if( !$this->field->upload ) rename( $oldpath, $newpath );
	...
	public function editView( $values )
	{
		...
		// print_r( parse_bracket_instructions( $this->field->upload, $values ) );exit;
		$temp->upload = isset( $this->field->upload ) ? parse_bracket_instructions( $this->field->upload, $values ) : 'library/upload/'.$this->field->folder;
